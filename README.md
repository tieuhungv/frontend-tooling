...
| ------------------------------------------------------------------------ | ------------------------ | -------------------- | ---------------------------------- |
| [`@tieuhungv/prettier-config`](./packages/prettier-config)               | Formatting rules         | `prettier.config.js` | `>=12.22` (use Prettier 2 on 12.x) |
| [`@tieuhungv/eslint-config`](./packages/eslint-config)                   | ESLint 9 **flat** config | `eslint.config.js`   | `>=18.18`                          |
| [`@tieuhungv/eslint-config-eslintrc`](./packages/eslint-config-eslintrc) | ESLint 8 **eslintrc**    | `.eslintrc.cjs`      | `>=12.22`                          |
...
| ----------------------------- | ----------------------------------- | -------------------------------------------------------------------------------------------------- |
| Node `>=18.18`, ESLint 9      | `@tieuhungv/eslint-config`          | `eslint.config.js` — see [eslint-config README](./packages/eslint-config/README.md)                |
| Node `12.22`–`17.x`, ESLint 8 | `@tieuhungv/eslint-config-eslintrc` | `.eslintrc.cjs` — see [eslint-config-eslintrc README](./packages/eslint-config-eslintrc/README.md) |
...
### ESLint 9 (`@tieuhungv/eslint-config`)
...
| Preset                                  | Use for                                                 |
| --------------------------------------- | ------------------------------------------------------- |
| `@tieuhungv/eslint-config` / `.../base` | JavaScript only                                         |
...
### ESLint 8 (`@tieuhungv/eslint-config-eslintrc`)

Same idea via `extends`:

| Preset                              | Use for                          |
| ----------------------------------- | -------------------------------- |
| `@tieuhungv/eslint-config-eslintrc` | JavaScript only                  |
| `.../typescript`                    | TypeScript (no React)            |
| `.../react`                         | React + TypeScript (not Next.js) |
| `.../next`                          | **Next.js**                      |
...
```sh
yarn add -D eslint prettier@3 @tieuhungv/eslint-config @tieuhungv/prettier-config
...
const nextConfig = require('@tieuhungv/eslint-config/next');
...
```sh
yarn add -D eslint@8 prettier@2 @tieuhungv/eslint-config-eslintrc @tieuhungv/prettier-config
...
Packages are published under scope **`@tieuhungv`** to
...
```ini
@tieuhungv:registry=https://npm.pkg.github.com
...
yarn add -D @tieuhungv/prettier-config @tieuhungv/eslint-config
```
...
(`@tieuhungv/eslint-config`). For `.eslintrc.cjs`, omit that setting.
